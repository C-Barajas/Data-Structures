...
//	Removes and returns the parameter object obj in least position in list if the list is not empty,
//	null if the list is empty.
	public E removeLast();
...
//	removes and returns the first matching element found when traversing the list from the first position.
...
//	Returns the last element in the lost, null if the list is empty.
//	The list is not modified.
	public E peekLast();
...
//	Returns the element matching obj if it is in the lis, null otherwise.
...
//	Returns and Iterator of the values in the list, presented in
//	the same order as the underlying order of the list. (front firts, rear last)
